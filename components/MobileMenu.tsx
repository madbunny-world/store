...
export default function MobileMenu() {
  ...
  return (
    <>
      ...
      {open && (
        <div className="absolute inset-x-0 top-full bg-white px-4 pb-6 pt-2 font-mono text-xs uppercase tracking-wider">
          <nav className="flex flex-col gap-4">
            ...
            <a href={INSTAGRAM_URL} target="_blank" rel="noopener noreferrer" className="hover:opacity-60">
              Instagram
            </a>
          </nav>
        </div>
